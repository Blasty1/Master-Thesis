...
\noindent \textbf{Preliminary Title: }Rolling Horizon Planning with Explainability for DRL-Based Engine Rescheduling \\
...
\noindent \textbf{Keywords:} Deep Reinforcement Learning, Explainable AI, Engine Rescheduling, PPO, Rolling Horizon Planning, Locomotive Assignment, Condition-Based Maintenance , Continuous Hazard Model , Shared-Weight Neural Networks , XAI
